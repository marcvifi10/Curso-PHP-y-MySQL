<html>
	...
	<body>
		<?php
			...
			$consulta = "UPDATE PRODUCTOS SET CODIGOARTICULO='$cod', SECCION='$sec', NOMBREARTICULO='$nom', PRECIO='$pre', FECHA='$fec', IMPORTADO='$imp', PAISORIGEN='$por' WHERE CODIGOARTICULO='$cod'";
