<html>
	...
	<body>
		<?php
			...
			{	
				// Imprime el primer campo ('nombre') de la primera fila de los resultados
				echo $fila['NOMBRE']." ";
				// Imprime el segundo campo ('apellidos') de los resultados
				echo $fila['APELLIDO']." ";
				// Imprime el tercer campo ('edad') de los resultados
				echo $fila['EDAD'];
